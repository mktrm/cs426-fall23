...
: [MIPS ISA](#) 
  ...
  : [<i class="icon fas fa-file-pdf"></i>](https://canvas.ucsd.edu/files/4737060/download?download_frd=1 "slides")[<i class="icon fas fa-chalkboard-teacher"></i>](https://canvas.ucsd.edu/files/4737962/download?download_frd=1 "annotated slides")[<i class="icon fas fas fa-video"></i>](https://canvas.ucsd.edu/courses/28054/external_tools/82 "video"){: .noclassatall}[**Weekly Check-in**](https://canvas.ucsd.edu/courses/28054/quizzes){: .label .label-purple }
