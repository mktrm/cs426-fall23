...
: [Instruction Set Architecture](https://canvas.ucsd.edu/files/4733454/download?download_frd=1)  
  ...
  : [<i class="icon fas fa-file-pdf"></i>](https://canvas.ucsd.edu/files/4733454/download?download_frd=1 "slides")[<i class="icon fas fa-chalkboard-teacher"></i>](https://canvas.ucsd.edu/files/4734944/download?download_frd=1 "annotated slides"){: .noclassatall}
